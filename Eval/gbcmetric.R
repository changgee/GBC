...
gbcmetric = function(S1,S2,p,n,clus_dir=2)
{
  ...
  list(L1=k1,L2=k2,CE=CE,FP_CE=FP_CE,FN_CE=FN_CE,TP_CE=TP_CE,TN_CE=TN_CE,SEN_CE=SEN_CE,SPE_CE=SPE_CE,MCC_CE=MCC_CE,CS=CS,FP=FP,FN=FN,TP=TP,TN=TN,SEN=SEN,SPE=SPE,MCC=MCC)
}
